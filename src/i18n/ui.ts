...
export const ui = {
  en: {
    ...
    interior: {
      ...
      hint: "WASD to walk. Step onto the stairs to climb, or up to a board to read it.",
      hintTouch: "Joystick to walk. Step onto the stairs to climb, or up to a board to read it.",
  ...
  pt: {
    ...
    interior: {
      ...
      hint: "WASD para andar. Pise na escada para subir, ou chegue a um quadro para ler.",
      hintTouch: "Joystick para andar. Pise na escada para subir, ou chegue a um quadro para ler.",
