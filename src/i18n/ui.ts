...
export const ui = {
  en: {
    ...
    interior: {
      ...
      leave: "Leave",
      read: "Read",
      leaveBuilding: "Leave the tower",
      goInside: "Step inside",
      floorOf: "Floor {n} of {total}",
      hint: "WASD to walk. Reach the ladder to climb, the hatch to go down, a board to read it.",
      hintTouch: "Joystick to walk. Reach the ladder to climb, the hatch to go down, a board to read it.",
  ...
  pt: {
    ...
    interior: {
      ...
      leave: "Sair",
      read: "Ler",
      leaveBuilding: "Sair da torre",
      goInside: "Entrar",
      floorOf: "Andar {n} de {total}",
      hint: "WASD para andar. Chegue à escada para subir, ao alçapão para descer, a um quadro para ler.",
      hintTouch: "Joystick para andar. Chegue à escada para subir, ao alçapão para descer, a um quadro para ler.",
