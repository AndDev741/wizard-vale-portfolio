...
export const experienceNpcs: ExperienceNpc[] = [
  ...
  },
  {
    ...
    deeds: [
      {
        en: "Moved the EMIR/SFTR analytics layer from PostgreSQL to StarRocks. One materialized view fell from 1 hour to 2.1 seconds, 1,700 times faster, and stays flat around 14s however much data arrives. The endpoint's p50 fell from 11,394ms to 943ms, and throughput rose 556%.",
        pt: "Movi a camada de analytics EMIR/SFTR do PostgreSQL para o StarRocks. Uma materialized view caiu de 1 hora para 2,1 segundos, 1.700 vezes mais rápida, e fica estável em torno de 14s por mais dados que cheguem. O p50 do endpoint caiu de 11.394ms para 943ms, e o throughput subiu 556%.",
      },
      {
      ...
      {
        en: "Standardised internationalisation, EN, PT and FR, as one shared package for every microservice and the React frontend, and centralised frontend permissions with React Context and custom hooks.",
        pt: "Padronizei a internacionalização, EN, PT e FR, como um pacote compartilhado por todos os microsserviços e pelo frontend React, e centralizei as permissões do frontend com React Context e hooks próprios.",
      },
    ],
    tech: [
      "Java",
